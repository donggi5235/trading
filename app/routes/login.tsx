...
export default function Login() {
  ...
  return (
    <div className={`${themeClasses}`}>
      ...
      <div
        className={`flex items-center justify-center px-4 py-24 transition-all duration-300 ${themeClasses}`}
      >
        <div
          className={`w-full max-w-md space-y-8 p-8 rounded-2xl shadow-2xl border transition-all duration-300 ${cardClasses}`}
        >
              ...
              <div className="flex items-center">
                <input
                  ...
                  className={`h-4 w-4 rounded border-2 ${
                    theme === "dark"
                      ? "border-slate-600 bg-slate-700 text-cyan-400 focus:ring-cyan-400"
          ...
          <div className="grid grid-cols-4 gap-3">
            <button
              ...
              className={`flex justify-center items-center p-3 rounded-lg border transition-all duration-200 hover:scale-105 ${
                theme === "dark"
